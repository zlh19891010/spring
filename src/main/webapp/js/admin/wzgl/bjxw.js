...
var ractive = new Ractive({
    ...
    oninit: function () {
        ...
        var ue;
        $.sdAjax({
            url: Constants.ctrlAddress + "xwxx/selectXwxxById?id=" + id,
            successCallback: function (data) {
                if (data && typeof data == "object") {
                    // 处理富文本编辑器中的图片地址
                    data.xwxq = convertImgUrlByUEditor(data.xwxq);
                    // 初始化富文本编辑器
        ...
        _this.on({
            ...
            save: function(event) {
                ...
                $.sdAjax({
                    url: Constants.ctrlAddress + "xwxx/updateXwxx",
                    type: "post",
                    data: xwxx,
                    successCallback: function (data) {
